...
#Anfw->m_a,rs->eps0
Anfw_par = Parameter("Anfw",  np.log10(3.46e-24), 0.01, (np.log10(1.0e-26), np.log10(1.0e-21)), "A_s")
rs_par =   Parameter("rs",  np.log10(6.26e-4), 0.01, (np.log10(1.0e-6), np.log10(1.0e-2)), "r_s")
phi0_par =   Parameter("phi0",  np.log10(1.0), 0.01, (np.log10(0.00001), np.log10(1.0)), "phi0")
phi1_par =   Parameter("phi1",  np.log10(3.70e-2), 0.01, (np.log10(0.00001), np.log10(1.0)), "phi1")
phi2_par =   Parameter("phi2",  np.log10(1.53e-1), 0.01, (np.log10(0.00001), np.log10(1.0)), "phi2")
# Restrained DE.
