...
#Anfw->m_a,rs->eps0
Anfw_par = Parameter("Anfw",  np.log10(1.8e-23), 0.01, (np.log10(1.0e-26), np.log10(1.0e-22)), "A_s")
rs_par =   Parameter("rs",  np.log10(2.1e-4), 0.01, (np.log10(1.0e-6), np.log10(1.0e-2)), "r_s")
...
phi2_par =   Parameter("phi2",  np.log10(3.82e-1), 0.01, (np.log10(0.00001), np.log10(1.50)), "phi2")
# Restrained DE.
