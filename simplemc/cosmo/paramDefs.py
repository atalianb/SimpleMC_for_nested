...
rs_par =   Parameter("rs",  np.log10(1.19e-3), 0.01, (np.log10(1.0e-5), np.log10(1.0e-2)), "r_s")
phi0_par =   Parameter("phi0",  np.log10(1.0), 0.01, (np.log10(0.01), np.log10(1.0)), "phi0")
phi1_par =   Parameter("phi1",  np.log10(1.0e-1), 0.01, (np.log10(0.001), np.log10(1.0)), "phi1")
phi2_par =   Parameter("phi2",  np.log10(1.5e-1), 0.01, (np.log10(0.001), np.log10(1.0)), "phi2")
# Restrained DE.
