...
#Anfw->m_a,rs->eps0
Anfw_par = Parameter("Anfw",  np.log10(2.29e-24), 0.01, (np.log10(1.0e-26), np.log10(1.0e-21)), "A_s")
rs_par =   Parameter("rs",  np.log10(1.17e-3), 0.01, (np.log10(1.0e-6), np.log10(1.0e-2)), "r_s")
...
phi2_par =   Parameter("phi2",  np.log10(1.0e-1), 0.01, (np.log10(0.00001), np.log10(1.0)), "phi2")
# Restrained DE.
